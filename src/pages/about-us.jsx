          ...
          <div className="flex justify-center">
            <div className="max-w-[700px] text-center">
              ...
              <div className="text-left font-semibold">
                ...
                <p className="mb-6 text-gray-600">
                  Fungsi utama dari Komoditasku adalah memberikan akses mudah
                  dan cepat kepada pengguna untuk memantau dan membandingkan
                  harga komoditas di pasar. Pengguna dapat mencari komoditas
                  spesifik yang mereka minati, seperti harga beras, gula atau
                  minyak.
                </p>
                <p className="mb-2 text-gray-600">
                  Berikut adalah beberapa fitur yang ditawarkan oleh
                  Komoditasku:
                </p>
                <ol className="list-inside list-decimal space-y-2 text-gray-600">
                  ...
                  <li>
                    Filter dan Pencarian: Pengguna dapat menggunakan fitur
                    filter dan pencarian untuk menemukan komoditas spesifik yang
                    mereka cari. Misalnya, pengguna dapat memfilter hasil
                    berdasarkan komoditi dan wilayah.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    juga menyediakan berita dan informasi terkait pasar
                    komoditas di Indonesia. Pengguna dapat mengakses
                    artikel-artikel terbaru tentang perubahan pasar,
                    faktor-faktor yang mempengaruhi harga, dan perkembangan
                    terbaru dalam industri komoditas.
                  </li>
                </ol>
                <p className="mb-16 mt-6 text-gray-600">
                  Dengan adanya Komoditasku, pengguna dapat mengakses informasi
                  harga komoditas dengan mudah dan dapat mengambil keputusan
                  yang lebih cerdas dalam perdagangan atau kegiatan bisnis
                  mereka. Website ini diharapkan dapat memberikan wawasan yang
                  lebih baik tentang pasar komoditas di Indonesia dan membantu
                  menghubungkan produsen, pedagang, dan konsumen komoditas
